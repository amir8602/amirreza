	       ...
	       <form:form   action="${registerUrl}"   method="post" modelAttribute="customer"     class="form-horizontal"  >
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
					   ...
					   <form:input path="name" class="form-control" placeholder="Enter Full Name" id="customerName" />
					</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
					   ...
					   <form:input path="customerEmail" class="form-control" placeholder="Enter Email Address" id="customerEmailAddress" />
					</div>
				</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
					   ...
					   <form:input path="customerPhoneNumber" class="form-control" placeholder="Enter Phone Number" id="custometPhoneNumber" />
					</div>
				</div>
